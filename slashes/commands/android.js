module.exports = (globalVariables) => {
  ...
  async function command(slash){
    if(slash.bot_scope) slash.callMessageEvent();
      ...
      try {
        let version = slash.content.split(" ")[1];
        if(version != undefined){
          ...
          if(ver == null) return slash.send("Please enter a correct android or api version");
          ...
          slash.send("Please enter an android version");
        }
      } catch(e){
